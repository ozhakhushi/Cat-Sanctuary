...
public class CatController : MonoBehaviour {
	...
	void Update () {
        ...
        if(enemy_State == CatState.PATROL) {
            Patrol();
        }

        if(enemy_State == CatState.CHASE) {
            Chase();
        }

        if (enemy_State == CatState.ATTACK) {
           Attack();
        }
